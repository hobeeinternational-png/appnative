...
const rawBundleId = "com.app.hobeemobile";
const bundleId =
  rawBundleId
...
const config: ExpoConfig = {
  ...
  plugins: [
    ...
    [
      "expo-location",
      {
        locationWhenInUsePermission: "Allow $(PRODUCT_NAME) to use your location to show nearby HOBEE places and open navigation.",
      },
    ],
    [
      "expo-notifications",
