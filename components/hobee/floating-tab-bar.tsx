...
const styles = StyleSheet.create({ normalContainer: { position: "absolute", left: 22, right: 22, zIndex: 20, alignItems: "center" }, barShell: { width: "100%", height: 58, position: "relative" }, bar: { width: "100%", height: 58, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, borderRadius: 29, overflow: "hidden", borderWidth: 1, borderColor: "rgba(255,255,255,0.18)", paddingHorizontal: 7, backgroundColor: "rgba(20,20,18,0.78)", ...HOBEE.elevation.floating }, navGroup: { flexDirection: "row", alignItems: "center", gap: 4 }, navCenterGap: { width: 64 }, centerOverlay: { position: "absolute", zIndex: 3, left: "50%", top: -24, marginLeft: -37 }, iconButton: { width: 44, height: 44, alignItems: "center", justifyContent: "center", borderRadius: 22 }, activeButton: { borderWidth: 1, borderColor: "rgba(255,238,185,0.28)", backgroundColor: "rgba(255,194,56,0.18)" }, centerButton: { width: 74, height: 74, alignItems: "center", justifyContent: "center", gap: 0, borderRadius: 37, borderWidth: 4, backgroundColor: "#D6AC48", ...HOBEE.elevation.floating }, centerButtonCompact: { width: FLOAT_SIZE, height: FLOAT_SIZE, marginTop: 0, borderRadius: FLOAT_SIZE / 2, borderWidth: 3 }, centerText: { color: "#1D1A18", fontSize: 11, fontWeight: "900", letterSpacing: -0.5 }, centerTextCompact: { fontSize: 10 }, floating: { position: "absolute", zIndex: 35 }, pressed: { opacity: 0.78, transform: [{ scale: HOBEE.motion.pressScale }] }, quickMenu: { position: "absolute", right: 22, left: 22, zIndex: 40, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, borderRadius: 15, overflow: "hidden", borderWidth: 1, borderColor: "rgba(255,255,255,0.13)", backgroundColor: "rgba(20,20,18,0.74)", padding: 11, ...HOBEE.elevation.floating }, quickMenuText: { color: "#FFFFFF", fontSize: 11, fontWeight: "800" }, badge: { position: "absolute", top: 4, right: 4, minWidth: 14, height: 14, alignItems: "center", justifyContent: "center", borderRadius: 7, backgroundColor: "#DE4A47", paddingHorizontal: 3 }, badgeText: { color: "#FFFFFF", fontSize: 7, fontWeight: "900" } });
