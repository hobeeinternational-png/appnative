...
const styles = StyleSheet.create({ normalContainer: { position: "absolute", left: 22, right: 22, zIndex: 20, alignItems: "center" }, bar: { width: "100%", height: 58, flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderRadius: 29, overflow: "hidden", borderWidth: 1, borderColor: "rgba(255,255,255,0.15)", paddingHorizontal: 7, backgroundColor: "rgba(20,20,18,0.72)", shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.2, shadowRadius: 14, elevation: 10 }, iconButton: { width: 44, height: 44, alignItems: "center", justifyContent: "center", borderRadius: 22 }, activeButton: { backgroundColor: "rgba(255,255,255,0.12)" }, centerButton: { width: 66, height: 66, marginTop: -18, alignItems: "center", justifyContent: "center", gap: 0, borderRadius: 33, borderWidth: 3, backgroundColor: "#D6AC48", shadowColor: "#000000", shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.2, shadowRadius: 7, elevation: 7 }, centerButtonCompact: { width: FLOAT_SIZE, height: FLOAT_SIZE, marginTop: 0, borderRadius: FLOAT_SIZE / 2, borderWidth: 3 }, centerText: { color: "#1D1A18", fontSize: 10, fontWeight: "900", letterSpacing: -0.5 }, centerTextCompact: { fontSize: 10 }, floating: { position: "absolute", zIndex: 35 }, pressed: { opacity: 0.78, transform: [{ scale: 0.96 }] }, quickMenu: { position: "absolute", right: 22, left: 22, zIndex: 40, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, borderRadius: 15, overflow: "hidden", borderWidth: 1, borderColor: "rgba(255,255,255,0.13)", backgroundColor: "rgba(20,20,18,0.74)", padding: 11, shadowColor: "#0A1F18", shadowOffset: { width: 0, height: 7 }, shadowOpacity: 0.18, shadowRadius: 12, elevation: 9 }, quickMenuText: { color: "#FFFFFF", fontSize: 11, fontWeight: "800" }, badge: { position: "absolute", top: 4, right: 4, minWidth: 14, height: 14, alignItems: "center", justifyContent: "center", borderRadius: 7, backgroundColor: "#DE4A47", paddingHorizontal: 3 }, badgeText: { color: "#FFFFFF", fontSize: 7, fontWeight: "900" } });
